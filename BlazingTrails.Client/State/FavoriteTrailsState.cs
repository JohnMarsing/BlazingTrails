...
public class FavoriteTrailsState
{
	...
	public async Task Initialize()
	{
		if (!_isInitialized)
		{
			_favoriteTrails = await _localStorageService.GetItemAsync<List<Trail>>
				(FavoriteTrailsKey) ?? new List<Trail>();
			_isInitialized = true;
	...
	/*
	This adds a trail to the list of favorites and persists a copy 
	of the favorite trails to local storage. Finally, it calls 
	NotifyStateHasChanged, which is responsible for triggering the OnChange event.
	*/
